...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sprinkler', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\SprinklerBundle\\Resources\\config\\doctrine') => 'SprinklerBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'SprinklerBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('SprinklerBundle' => 'SprinklerBundle\\Entity'));
    ...
    /**
     * Gets the 'overcast' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VertigoLabs\Overcast\Overcast A VertigoLabs\Overcast\Overcast instance.
     */
    protected function getOvercastService()
    {
        return $this->services['overcast'] = new \VertigoLabs\Overcast\Overcast('52a922ed7f8951840188f2b09dd90dd4');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SprinklerBundle/Resources/views'), 'Sprinkler');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2feb136a758f1cb17a6c4c42553ff871d0462a50');
    }
    ...
    {
        return $this->services['weather.repository'] = new \SprinklerBundle\Repository\WeatherRepository($this->get('overcast'), $this->get('geocode'), '2059 E Lindrick Dr, Gilbert, AZ 85298');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('571aa73556a642.47618286')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SprinklerBundle' => 'SprinklerBundle\\SprinklerBundle',
            ...
            'address' => '2059 E Lindrick Dr, Gilbert, AZ 85298',
